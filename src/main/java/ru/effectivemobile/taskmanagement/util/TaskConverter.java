...
public class TaskConverter {
     ...
     */
    public static Task toEntity(TaskRequestAdminDto dto, User admin, User assignee, Status status, Priority priority) {
        return Task.builder()
                ...
                .priority(priority)       // Set the priority from the DTO.
    ...
    public static Task toEntity(TaskRequestUserDto dto, User user, Status status, Priority priority) {
        return Task.builder()
                .title(dto.getTitle())            // Set the title from the DTO.
                .description(dto.getDescription()) // Set the description from the DTO.
                .status(status)           // Set the status from the DTO.
    ...
    public static TaskResponseDto toDto(Task task) {
        ...
        try {
            dto.setPriorityCode(PriorityCode.valueOf(task.getPriority().getCode()));
        } catch (IllegalArgumentException e) {
            throw new RuntimeException("Unknown priority code: " + task.getPriority().getCode());
        }
